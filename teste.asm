...
TERMINA_VIDEO	EQU 6066H	  	; endereço do comando para terminar o vídeo de fundo em loop
SELECIONA_FUNDO	EQU 6042H 		; endereço do comando para selecionar uma imagem de fundo
APAGA_FUNDO		EQU 6044H		; endereço do comando para apagar a imagem de fundo
...
MOV		[SELECIONA_FUNDO],R1			; imagem inicial do jogo
MOV  	BTE, tab						; inicializa BTE (registo de Base da Tabela de Exceções)
EI0										; permite interrupções 0
EI										; permite interrupções (geral)

CALL    inicio_jogo		; tela inicial jogo
...
inicio_jogo:
	CALL	teclado
	CMP 	R0,11			; compara a tecla pressionada com a tecla BH = 11		
	JNZ		inicio_jogo
	MOV		[APAGA_ECRA], 1 	; apaga o fundo inicial
	MOV		[VIDEO], 0		;mete o video do jogo		
	RET
...
ciclo:
	...
	CALL 	teclado
	CALL	display
	CMP		R0, 14			; tecla da pausa EH = 14
	JZ		pausa
	...
	pausa:
		MOV		R0, 1
		MOV 	[SELECIONA_FUNDO], R0		; seleciona o fundo de pausa
		MOV		[APAGA_ECRA], R0			; apaga todos os pixeis ja desenhados	
		CALL	teclado
		CMP 	R0, 14
		JNZ		pausa
		MOV		R3, DEF_NAVE
...
; ***********************************************************************
; * Descrição:			Tela inicial do jogo							*
; * Argumentos:			R1 - nº da imagem de fundo inicial				*
